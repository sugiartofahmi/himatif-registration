<template>
  ...
  >
    <div class="flex gap-3 mr-7 justify-center items-center">
        ...
        <ul>
          <li>
            <router-link :to="'/user/dataDiri/' + id">
              <a class="flex items-center px-2 py-2" href="#">
                <img src="../../../assets/icon/user-icon.svg" alt="icon user" />

                <span class="ml-3 font-medium">Data Diri</span>
              </a>
            </router-link>
          </li>
          <li>
            <router-link :to="'/user/seleksi/' + id">
              <a class="flex items-center px-4 py-2" href="#">
                ...
                <span class="ml-5 font-medium">Seleksi</span>
              </a>
            </router-link>
          </li>
          <li>
            <router-link :to="'/'">
              <a class="flex items-center px-3 py-2" href="#">
                <img
                  src="../../../assets/icon/logout-icon.svg"
                  alt="icon user"
                />

                <span class="ml-5 font-medium">Log Out</span>
              </a>
            </router-link>
          </li>
        </ul>
